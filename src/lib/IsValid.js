...
export class IsValid {
    static fields(data, schema) {
        ...
        const dataKeysCont = Object.keys(data).length; //4
       
        if (dataKeysCont !== requiredKeysCount) 
            return [true, 'atejusiuose duomenyse dumenu kiekis nesutampa su reikalaujama apimtimi']
